...
import sheepLadderDonationsImage from '@/context/HDGqpa8dGw.jpg'
...
export const articles: Article[] = [
...

  {
    id: '98437349',
    title:
      'Trump Declares an “Economic D-Day” Against Iran and Warns Any Country That Offers Tehran a Lifeline',
    summary:
      'The president says Washington will mount “the most crushing economic operation ever taken against any country,” with foreign banks, airports, ship registries and front companies all named as targets.',
    body: [
      'President Trump said Wednesday that the United States will open a sweeping economic campaign against Iran and the states and companies that trade with it, describing the effort as an “Economic D-Day” and promising “the most crushing economic operation ever taken against any country.”',
      'Writing on Truth Social, the president framed the move as the consequence of a settlement Tehran declined to take. “No one has given the Islamic Republic of Iran a greater opportunity to make a Deal than me,” he wrote, adding that “TRAGICALLY, for them, they have failed to take it.”',
      'What distinguishes the announcement from previous rounds of pressure is its reach beyond Iran’s own borders. Any country that allows its financial institutions, businesses, airports or government entities to provide “any type of lifeline” to Iran will itself face “TREMENDOUS Economic Consequences,” Trump wrote.',
      {
        type: 'list',
        items: [
          'Oil smuggling and the shadow tanker fleet that moves it',
          'Swap lines and cash transfers routed through third countries',
          'Exchange houses handling Iranian settlement',
          'Ship registries flagging Iranian-linked vessels',
          'Front companies used to disguise ownership and trade',
        ],
      },
      '“It all needs to stop NOW. You know who you are,” the president wrote of that list, calling on “our Allies to stand with the United States of America to isolate, and defeat, the Iran threat.”',
      {
        type: 'image',
        src: iranTankerTrafficImage,
        caption:
          'Illustrative: container and tanker traffic at a commercial port. Ship registries and front companies are named among the campaign’s targets.',
        alt: 'Aerial view of a commercial container port with stacked freight and berthed ships',
      },
      { type: 'heading', text: 'A deadline that came and went' },
      'The declaration follows the expiry on Monday of the 60-day negotiating window created by the interim agreement signed in June. That period closed without a breakthrough, and on Tuesday the president indicated that no further talks with the regime are scheduled.',
      'The US naval blockade of Iranian ports in the Strait of Hormuz “remains in full force and effect,” Trump said this week.',
      'The president argued that the campaign lands on a state already reeling, saying Iran is “hanging by a thread” after American strikes that he said devastated its navy, air force and military infrastructure. “These maniacs are on the ropes, and these HISTORIC MEASURES will cripple them and their ability to project terror worldwide,” he wrote, closing the post with the line he has repeated throughout the confrontation: “IRAN WILL NEVER HAVE A NUCLEAR WEAPON.”',
      'The post did not set out which authorities the administration intends to use, name the countries it has in mind, or say when the measures take effect. The White House did not immediately respond to questions about the operational detail.',
      'Reporting in this story is based on the president’s public statements and on coverage by the New York Post, which first reported the announcement. The header photograph is a stock file image, not a photograph of the events described.',
    ],
    category: 'World',
    time: '18:40',
    section: 'hot',
    image: iranPortSanctionsImage,
...

  {
    id: '98437350',
    title:
      'Two Milligan University Cyclists Killed and Seven Hurt After Driver Plows Into Team Training Ride',
    summary:
      'Sophomores Haylan Engdahl and Brayden Rogers died at the scene on Highway 19E in Hampton, Tennessee. A 69-year-old North Carolina man faces two counts of vehicular homicide by recklessness.',
    body: [
      'Two Milligan University cyclists were killed and seven more were injured Wednesday morning when a driver struck their training group on a rural highway in East Tennessee, in a crash prosecutors say was the result of reckless driving.',
      'Sophomores Haylan Engdahl and Brayden Rogers were part of an 11-rider training session when the group was hit just before 9 a.m. on Highway 19E in Hampton, roughly 11 miles from campus, according to the Tennessee Highway Patrol. Both were pronounced dead at the scene.',
      {
        type: 'image',
        src: cyclingPelotonImage,
        caption:
          'Illustrative: a cycling team on a training ride. Prosecutors described the Milligan group as an elite squad on a routine session.',
        alt: 'A tightly grouped pack of road cyclists riding together on an open road',
      },
      'Seven injured riders were taken to Johnson City Medical Center. Four were in critical condition in the surgical intensive care unit and two were stable, trauma director Dr. Bracken Burns said; a seventh was evaluated and released. The injured athletes have not been publicly identified.',
      '“We are profoundly shocked and saddened to share that members of our cycling team were in an accident involving a vehicle this morning while cycling,” Milligan University said in a statement. “There are no words to adequately describe this level of loss.”',
      { type: 'heading', text: 'Charges and the investigation' },
      'John Benfield, 69, of Newland, North Carolina, has been charged with two counts of vehicular homicide by recklessness and five counts of aggravated assault by vehicle by recklessness, First Judicial District Attorney General Steven Finney said. Benfield is being held in the Carter County jail, and Finney said further charges are possible as the investigation continues.',
      'Prosecutors have not said whether the driver is suspected of being impaired, and released few details about how the collision unfolded. Finney was firm on one point: the riders were not at fault. “This is an elite cycling team. It’s not a bunch of club guys getting together to ride,” he said. “They know what they’re doing.”',
      '“Today has been an extraordinarily difficult day for a lot of people in upper East Tennessee,” the Tennessee Highway Patrol said. “Families have lost loved ones. Others are waiting for news about people who were hurt.”',
      { type: 'heading', text: 'Two riders remembered' },
      'Engdahl, from Winthrop Harbor, Illinois, had recently returned to training after breaking his femur in a crash in March. Jeff Bogaczyk, head of school at Christian Life School in Kenosha, Wisconsin, where Engdahl was a student, described him to ABC7 Chicago as “a beautiful person, infectious smile, magnetic personality, loved life.”',
      'Rogers, a sophomore at the private Christian university, was from Huntsville, Alabama. USA Cycling said its “hearts go out to the two student-athletes whose lives were taken far too soon,” as well as to the injured riders.',
      'The crash is the second time in four years that a Milligan athlete has been killed while training on a public road. Sophomore runner Eli Cramer was struck and killed by a drunk driver in Lightfoot, Virginia, in March 2022 while on a pre-meet run with two teammates; the driver was sentenced to 12 years in prison in April 2023.',
      'Reporting in this story is based on statements from the Tennessee Highway Patrol, the district attorney’s office, Milligan University and USA Cycling, and on coverage by the New York Post. The photographs are stock file images, not photographs of the events described.',
    ],
    category: 'US News',
    time: '10:20',
    section: 'hot',
    image: cyclingTeamImage,
    byline: 'Alma Shriq News National Desk',
    date: '2026-08-20',
  },

  {
    id: '98437351',
    title:
      'Fairfax Police Say Restaurant Worker Stabbed a Colleague, Then Tried to Set Her Body Alight',
    summary:
      'Alexis Antonio Cedillos-Campos, 19, has confessed to killing 42-year-old Carmen Lizet Puch, a mother of a 3-year-old girl, in what the county police chief called an attack that was “all very premeditated.”',
    body: [
      ...
      { type: 'heading', text: '“All very premeditated”' },
      ...
      { type: 'heading', text: 'Immigration status becomes a flashpoint' },
...

  {
    id: '98437352',
    title:
      'Harry and Meghan Say Montecito Isn’t for Sale. The Carrying Costs Tell a Different Story',
    summary:
      'The Sussexes are moving the family to Britain while insisting they will keep the California estate — but the mortgage and tax bill alone runs past $600,000 a year, and Santa Barbara brokers say a listing is already being discussed.',
    body: [
      ...
      { type: 'heading', text: 'What the house costs to keep' },
      ...
      {
        type: 'image',
        src: montecitoGroundsImage,
        caption:
          'Illustrative: a California estate property. The Montecito house runs about 18,000 square feet on 7.38 acres, with nine bedrooms and 17 bathrooms.',
        alt: 'A large modern estate house with a swimming pool and landscaped grounds',
      },
      { type: 'heading', text: 'What it might fetch' },
      ...
      { type: 'heading', text: 'A move, and a thinner income' },
    ...
    time: '16:25',
    section: 'finance',
    image: montecitoEstateImage,
    byline: 'Alma Shriq News Real Estate Desk',
    date: '2026-08-19',
  },

  {
    id: '98437353',
    title: 'Extra Rest Didn’t Fix It: Skenes Pulled After 4⅓ as Pirates Edge Tigers',
    summary:
      'Pittsburgh pushed its ace back a few days to let him reset. He answered with 81 pitches, four walks and another early exit — though the velocity did creep back up.',
    body: [
      'The Pirates gave Paul Skenes extra time to get right. On Wednesday it bought them 15 more pitches and not much else.',
      'Skenes lasted 4⅓ innings and 81 pitches against the Tigers at PNC Park, allowing three runs on four hits and four walks while striking out five. Pittsburgh still took the game 4-3.',
      'The right-hander had originally been slated to start Sunday against the Red Sox before the club moved him to the middle of the week. Manager Don Kelly said Skenes was not dealing with an injury and that the change was meant to give him “a few more days to recover.”',
      { type: 'heading', text: 'The velocity is back. The command isn’t.' },
      'There was one clear gain. Skenes threw 21 pitches at 97 mph or harder, up from a high-water mark of 96.5 mph in his previous outing, a 65-pitch effort against the Marlins on Aug. 11. The four walks, though, matched a season high.',
      '“I think there’s been a lot of good,” Skenes said, according to MLB.com. “I think there’s some stuff, the walks. It’s frustrating. Nobody wants to go out there and walk anybody. Nobody’s trying to. … Felt good. Just a little out of sync, I guess, kind of the whole outing, which probably makes sense a little bit with the longer rotation. But nice to be back.”',
      { type: 'heading', text: 'A different season by his own standard' },
      'The 2024 National League Rookie of the Year and 2025 Cy Young winner carries a 3.95 ERA and a 1.14 WHIP across 139 innings this season. Set against the 1.96 ERA and 0.95 WHIP of his first two years, that reads like a slump; set against the league, it does not.',
      'Infielder Brandon Lowe argued the expectations are the problem. “I think the world’s been spoiled on who Paul Skenes really is,” he said, according to the Associated Press. “He had probably the best starting stretch to a career ever. And now he’s not the greatest pitcher on the face of the planet for a few months, and people were worried and freaking out a bit.”',
      'If Skenes finishes the year on schedule he should clear 200 strikeouts again, after 216 last season. He said his own read on the season will come from the numbers rather than the noise: “Just objective numbers, watching the game, execution, all that stuff. Not anything from the outside.”',
      'Reporting in this story is based on game data and on quotes reported by MLB.com and the Associated Press, as compiled by the New York Post. The photographs are stock file images, not photographs of the events described.',
    ],
    category: 'MLB',
    time: '23:15',
    section: 'sports',
...

  {
    id: '98437354',
    title:
      'Ossoff’s Sly Dig at a Trump Aide Was Built to Wound the President. It Landed on Him Instead',
    summary:
      'The Georgia senator’s line about Trump wanting to “travel with Natalie” was engineered to be deniable. New York Post columnist Miranda Devine argues it revealed more about Ossoff than about his target.',
    body: [
      'At a rally in Atlanta on Sunday, Sen. Jon Ossoff worked a single first name into an otherwise conventional list of grievances against President Trump. Trump, he said, “doesn’t want to do the job; he wants to build his ballroom and travel with Natalie.”',
      'The Natalie in question is Natalie Harp, 35, the aide who posts the president’s social media messages and has been a fixture at his side since before his return to office. Democrats insisted afterwards that nothing untoward had been implied. The coverage that followed suggested otherwise, and CNN in particular ran hard with the story.',
      'Writing in the New York Post, columnist Miranda Devine argues the ambiguity was the point — a smear constructed so that its author could disown it, aimed at a woman who had no way to answer back.',
      { type: 'heading', text: 'Who Natalie Harp is' },
      'Harp battled debilitating bone cancer in her twenties, an illness that left her in severe pain and in a wheelchair. She credits Trump with saving her life by expanding patients’ access to experimental drugs during his first term, and said so in a speech at the 2020 Republican National Convention while she was an anchor at One America News Network. He asked her to work for him in the years between his presidencies, and she stayed through the court cases and the assassination attempts.',
      'She does not give interviews. Friends say she has told them she is “staying focused, on mission, 24/7. Too much to do, and too little time to do it.”',
      { type: 'heading', text: 'What the pile-on turned up' },
      'Very little, in Devine’s telling. CNN interviewed Harp’s estranged brother Preston, 38, who is openly hostile to the president and who nonetheless ruled out any romantic relationship. His explanation was that their upbringing, not attraction, accounted for his sister’s loyalty: “Trump is like everything that my mom taught us to respect,” he said. “I think that’s where her infatuation for Trump comes from, honestly, because I don’t think it’s a physical attraction.”',
      'The family’s private grief — their father’s suicide in 2020 — was dredged up in the same week. Sarah Matthews, a former deputy press secretary from Trump’s first term who later backed Kamala Harris, told CNN the Secret Service had been “alarmed” by Harp’s closeness to the president, a claim complicated by the fact that Matthews left the White House before Harp began working for Trump.',
      'Devine’s argument is that the insinuation collapses under its own logic, and says something unflattering about the man who made it: that a hard-working professional woman could not have risen without sleeping with her boss. It is an odd position, she notes, for a senator who has spent years cultivating a decorous, Obama-inflected image.',
      'The president responded in kind, labeling Ossoff “Pee Wee Herman.” The more telling verdict came from Ossoff’s own side: Democratic strategist David Axelrod called the remarks “gratuitous and unnecessary.”',
      'This piece summarizes and responds to a New York Post column by Miranda Devine. The judgments described are hers; quotes are as reported by the Post, CNN and the outlets named. The photograph is a stock file image.',
    ],
    category: 'Opinion',
    time: '20:10',
    section: 'opinion',
    image: washingtonDcImage,
    byline: 'Alma Shriq News Opinion',
    date: '2026-08-19',
  },

  {
    id: '98437355',
    title:
      'The DSA’s Leading Lights Keep Turning Out to Be Children of the Class They Want to Abolish',
    summary:
      'A New York Post editorial argues that the movement now shaping New York City policy is run by people insulated from the consequences of its ideas — starting with a co-chair living in a house his father bought him.',
    body: [
      'The New York Post’s editorial board makes a blunt argument about the Democratic Socialists of America: the people steering it are, with striking consistency, the children of the professional and moneyed classes their program is meant to dismantle. The board’s case is a roll call.',
      'Gustavo Gordillo, co-chair of the city branch, lives in a million-dollar Brooklyn house that his father bought and had remodeled for him and his brother, and who also covered his rent for years. The Yale graduate, the editorial says, spent his thirties presenting himself as an electrician while climbing the DSA ladder. His parents — Peruvian immigrants who prospered in America — own two Florida properties, one of them listed on the rental market at $11,000 a month.',
      'That biography, in the board’s view, explains a remark Gordillo made about neighborhood grocers driven out of business by city-owned, tax-subsidized stores: they “shouldn’t have been in that business in the first place.” Someone who has never carried a small business’s risk, the editorial argues, can treat its destruction as a rounding error in a larger plan.',
      { type: 'heading', text: 'The rest of the roster' },
      {
        type: 'list',
        items: [
          'Mayor Zohran Mamdani’s mother, the filmmaker Mira Nair, has said the family is “privileged to have three homes” — apartments in Manhattan and New Delhi, plus a villa in Kampala, Uganda.',
          'Cea Weaver, who runs Mamdani’s Office to Protect Tenants, calls homeownership a “weapon of white supremacy”; her mother, a full professor at Vanderbilt, owns a $1.6 million house in Nashville.',
          'City Councilman Chi Ossé is the son of a prominent hip-hop music attorney and the grandson of Grammy-winning songwriter Teddy Vann; a college dropout, he worked briefly as a promoter before winning his seat at 23.',
          'Tracy Rosenthal, a rent abolitionist and Mamdani ally whose father won multiple Grammys, grew up in a million-dollar Lower Manhattan apartment and has boasted of bankrupting a landlord by refusing to pay rent for years.',
          'Grace Mausser, Gordillo’s fellow co-chair, grew up in a well-off Houston suburb before attending George Washington University.',
        ],
      },
      { type: 'heading', text: 'Why the editorial thinks it matters' },
      'The board’s conclusion is not simply that these people are hypocrites. It is that inherited comfort buys the freedom to be wrong at other people’s expense — to “preen about supposedly working as class traitors” while never facing the bill. Socialism has failed wherever it has been tried, the editorial argues, but the idea flatters those who hold it, and flattery is cheap when someone else is paying the rent.',
      'What has changed, in the board’s reading, is the stakes. These are no longer campus positions held by people with no power to act on them. The same figures now hold City Hall offices and council seats, with the authority to turn ideas absorbed in seminar rooms into policy that lands on grocers, landlords and tenants who never got a vote on the theory.',
      'This piece summarizes a New York Post editorial. The characterizations and judgments described are the Post editorial board’s, not this newsroom’s. The photograph is a stock file image.',
    ],
    category: 'Opinion',
    time: '08:30',
    section: 'opinion',
...

  {
    ...
    byline: 'Alma Shriq News Politics Desk',
    date: '2026-08-12',
  },
...

  {
    ...
    byline: 'Alma Shriq News Human Interest Desk',
    date: '2026-08-12',
  },
...

  {
    ...
    byline: 'Alma Shriq News Editorial Board',
    date: '2026-07-31',
  },
...

  {
    ...
    byline: 'Alma Shriq News Media Desk',
    date: '2026-07-31',
  },

  {
    ...
    byline: 'Alma Shriq News Editorial',
    date: '2026-07-30',
  },
...

  {
    ...
    byline: 'Alma Shriq News Live Desk',
    date: '2026-06-11',
  },
  ...
  },
  {
    ...
    byline: 'Alma Shriq News Food Desk',
    date: '2026-05-06',
  },
  ...
  },
  {
    ...
    section: 'hot',
    image: k9DogImage,
    byline: 'Alma Shriq News American News Desk',
    date: '2026-05-02',
  },
  /*{
    id: '98437298',
    ...
    body: [
      ...
      'The project marks a sharp expansion from the company\'s earlier animal studies. Neuralink has previously focused public attention on pigs, sheep and monkeys while developing its brain-computer interface implants, but Mikolas represents a different class of challenge. A pygmy hippo is larger, denser, more difficult to handle, and neurologically more demanding than the animals normally associated with early neural-interface research.',
      {
        type: 'image',
        src: mikolasImage,
        caption: 'Mikolas, the pygmy hippo Neuralink has reportedly selected for its largest animal-testing program so far. (Image: facility photo shared with Alma Shriq News.)',
  ...
  },
  {
    ...
    byline: 'Alma Shriq News Markets Desk'
  },
  {
    id: '98437241',
    ...
    byline: 'Alma Shriq News Economy Desk'
  },
  {
    id: '98437242',
    ...
    body: [
      ...
      'Stay with Alma Shriq News for live updates throughout the day, including the keynote that everybody flew in for.'
    ],
    category: 'Live',
    time: '14:00',
    section: 'live',
  ...
  },
  {
    ...
    time: '09:30',
    section: 'newspaper',
    byline: 'Alma Shriq News Policy Desk'
  },
  {
    id: '98437247',
  ...
  },
  {
    ...
    body: [
      ...
      'Alma Shriq News will live-cover the announcement on tomorrow\'s page from before the open. If the rumors are even half right, this will be a long day.'
    ],
    category: 'Live',
    time: '07:30',
    section: 'live',
  ...
  },
  {
    ...
    time: '09:45',
    section: 'finance',
    byline: 'Alma Shriq News Finance Desk',
    date: '2026-04-16'
  },
  ...
  },
  {
    ...
    time: '13:05',
    section: 'culture',
    byline: 'Alma Shriq News Entertainment Desk'
  },
  {
    id: '98437274',
